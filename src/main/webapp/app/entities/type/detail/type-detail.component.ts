...
import { EntityArrayResponseType as TypeEntityArrayResponseType, TypeService } from 'app/entities/type/service/type.service';
...
export class TypeDetailComponent implements OnInit, OnDestroy {
  ...
  protected queryJobBackend(): Observable<JobEntityArrayResponseType> {
    ...
    return this.jobService.type(this.type()?.type ?? '', queryObject).pipe(tap(() => (this.isLoading = false)));
  }
