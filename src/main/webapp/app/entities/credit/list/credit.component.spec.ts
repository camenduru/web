...
import { sampleWithRequiredData } from '../credit.test-samples';
...
describe('Credit Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, CreditComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.credits?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
