...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '46af37be-6fc8-49b4-8b74-a2b23c50a386' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('81de2e70-9079-4eef-8608-ad3d76b27396');
      cy.get(`[data-cy="name"]`).should('have.value', '81de2e70-9079-4eef-8608-ad3d76b27396');
